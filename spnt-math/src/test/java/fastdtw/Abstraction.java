...
public class Abstraction
{
      ...
      public static void main(String[] args)
      {
         ...
         else
         {
            ...
            final WarpPath coarsePath = new DTW().getWarpPathBetween(shrunkI, shrunkJ);
            ...
            final TimeWarpInfo info = new DTW().getWarpInfoBetween(tsI, tsJ, w);
