...
INSERT into QSEGMENTEXP_BEFORECLEAN(ID,LENGTH,START,WAVFILEPATH,MARKERLABEL, CORPUSENTRYNAME, MANUALNAME, PLPLABEL, LPCLABEL, MFCCLABEL,SIGNALENTROPYLABEL,LOUDNESSLABEL,SPECTRALFLUXLABEL, PROCEESSTIME,LOUDNESS,SPECTRALFLUX,PLP,LPC,MFCC,SIGNALENTROPY,TIMESTAMP )
select ID,LENGTH,START,WAVFILEPATH,MARKERLABEL,CORPUSENTRYNAME,
REPLACE(MANUALNAME,'.','') MANUALNAME,
REPLACE(PLPLABEL,'.','') PLPLABEL,
REPLACE(LPCLABEL,'.','') LPCLABEL,
REPLACE(MFCCLABEL,'.','') MFCCLABEL,
REPLACE(SIGNALENTROPYLABEL,'.','') SIGNALENTROPYLABEL,
REPLACE(LOUDNESSLABEL,'.','') LOUDNESSLABEL,
REPLACE(SPECTRALFLUXLABEL,'.','') SPECTRALFLUXLABEL,
PROCEESSTIME,LOUDNESS,SPECTRALFLUX,PLP,LPC,MFCC,SIGNALENTROPY,TIMESTAMP
from QSEGMENTEXP
