 ...
 */
public class AsymmetricStatisticalBarRenderer extends StatisticalBarRenderer
    ...
    public void drawItem(Graphics2D g2,
        ...
        if (!(data instanceof AsymmetricStatisticalCategoryDataset)) {
            throw new IllegalArgumentException(
                "Requires AsymmetricStatisticalCategoryDataset.");
        }
    ...
    protected void drawHorizontalItem(Graphics2D g2,
                                      ...
                                      CategoryAxis domainAxis,
                                      ValueAxis rangeAxis,
                                      AsymmetricStatisticalCategoryDataset dataset,
                                      int visibleRow,
                                      int row,
                                      int column) {
