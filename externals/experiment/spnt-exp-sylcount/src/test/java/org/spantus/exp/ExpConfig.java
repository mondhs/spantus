...
public class ExpConfig {
	...
	public final static String EXP_ROOT_PATH= "/home/mondhs/src/tmp/sylcount_exp";
	...
	private final static String DIR_LEARN_WAV =
			"/home/mondhs/src/tmp/sylcount_exp/wav";
	// "/mnt/audio/VDU_ISO4"
...
//			"/home/as/src/spantus-svn/trunk/spnt-work-ui/src/main/resources/" +
	...
	private double threasholdCoef = 2.0;
	...
	public static ExpConfig createConfig() {
		...
		config.setDirLearn(DIR_LEARN_WAV);
		...
		config.setMarkerFilePrefix(".mspnt.yaml");
		OnlineDecisionSegmentatorParam segmentationParam = new OnlineDecisionSegmentatorParam();
		segmentationParam.setMinLength(91L);
		segmentationParam.setMinSpace(61L);
		segmentationParam.setExpandStart(60L);
		segmentationParam.setExpandEnd(60L);
...
//		ExtractorParam thresholdCoefParam = new ExtractorParam();
		...
		for (ExtractorEnum extractorEnum : config.getExtractors()) {
