...
import org.spantus.sphinx.dialog.DialogNode;
...
public class DialogNodeBehavior {
    ...
    public String onRecognize(Result result) throws GrammarException {
        ...
        LOG.debug("Recognize result: {}", result.getBestFinalResultNoFiller());
        LOG.debug("Recognize tag   : {}", tagString);
        return tagString;
    }
