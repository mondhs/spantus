 ...
 */
public class ViewAudioFormActivity extends Activity
    implements MarkerView.MarkerListener,
               WaveformView.WaveformListener
{
	private static final Logger LOG = Logger.getLogger(ViewAudioFormActivity.class);
...
//        mLoadingStartTime = System.currentTimeMillis();
        ...
        mProgressDialog = new ProgressDialog(ViewAudioFormActivity.this);
        mProgressDialog.setProgressStyle(ProgressDialog.STYLE_HORIZONTAL);
        mProgressDialog.setTitle(R.string.PROGRESS_LOADING);
...
//                    getPreferences(Context.MODE_PRIVATE));
        ...
        new Thread() { 
            public void run() { 
                try {
                    mSoundFile = CheapSoundFile.create(mFilename,
                                                       listener);
...
//                        mHandler.post(runnable);
                ...
                if (mLoadingKeepGoing) {
                    ...
                    ViewAudioFormActivity.this.finish();
                }
            } 
        }.start();
    }
...
//                float saveVel = mFlingVelocity;
    ...
    private void enableDisableButtons() {
        if (mIsPlaying) {
            ...
            mPlayButton.setContentDescription(getResources().getText(R.string.STOP_PLAYING));
        } else {
...
//        }
//
//        new AlertDialog.Builder(ViewAudioFormActivity.this)
//            .setTitle(title)
//            .setMessage(message)
//            .setPositiveButton(
...
//        Linkify.addLinks(message, Linkify.ALL);
//
//        final AlertDialog dialog = new AlertDialog.Builder(ViewAudioFormActivity.this)
