...
//    protected URL mInputFile = null;

    protected CheapSoundFile() {
    }

    public void readFile(URL inputFile) throws IOException {
    	throw new IllegalArgumentException("This should be never called");
    }
    ...
    public String computeMd5OfFirst10Frames(File mInputFile)
            throws java.io.FileNotFoundException,
                   java.io.IOException,
