...
public class RestClientString {
	...
	public RestClientString(String url) {
		this.url = url;
	...
	public void Execute(RequestMethod method) throws Exception {
		...
		case PUT: {
			// add parameters
			String combinedParams = combineParams(params);
	...
	private String combineParams(ArrayList<NameValuePair> aParams)
			throws UnsupportedEncodingException {
		String combinedParams = "";
		if (!aParams.isEmpty()) {
			combinedParams += "?";
			for (NameValuePair p : aParams) {
	...
	private void executeRequest(HttpUriRequest request, String url) {
		...
		try {
			...
			if (entity != null) {
				...
				convertStreamToResponse(instream);
