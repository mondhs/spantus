...
public class WamiAudioApplet extends JApplet implements SpntAudoListener,
SpntSpeechDetectorListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = 6539513493180905615L;
