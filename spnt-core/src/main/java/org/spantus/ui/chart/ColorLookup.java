...
public class ColorLookup {
	...
	private VectorSeriesColorEnum type = VectorSeriesColorEnum.normal;
	...
	public ColorLookup(VectorSeriesColorEnum type) {
		this();
		this.type = type;
	}

	public Color lookup(short s) {
		return lookup(getType(), s);
	}
	...
	public VectorSeriesColorEnum getType() {
		return type;
	}

	public void setType(VectorSeriesColorEnum type) {
		this.type = type;
	}
